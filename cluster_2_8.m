...
rng('default');
 fprintf('3 clusters')
 [IDX_3, C_3, SUMD_3, D_3, MIDX_3, INFO_3] = kmedoids(X,3,'distance','hamming','replicates',90,'OnlinePhase','off', 'Algorithm','clara');
rng('default');
 fprintf('4 clusters')
[IDX_4, C_4, SUMD_4, D_4, MIDX_4, INFO_4] = kmedoids(X,4,'distance','hamming','replicates',90,'OnlinePhase','off', 'Algorithm','clara');
rng('default');
 fprintf('5 clusters')
